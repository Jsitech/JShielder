...
For Debian 10
Developed By Jason Soto & Modified by Girish Mahabir                                                        
"
echo
echo
...
echo -e "Let's set a root password"
passwd root

# Unattended Upgrades
apt install -y unattended-upgrades apt-listchanges bsd-mailx
...
f_banner
echo -e ""
echo -e "NOT Installing and configuring AIDE"
...
if [ -f /home/$username/.ssh/authorized_keys ]; then
  ...
  echo -e "Authorized Key file does not exist for $username"
  echo -e "Creating Authorized Key file for $username"
  mkdir /home/$username/.ssh
  touch /home/$username/.ssh/authorized_keys
  chown -R $username:$username /home/$username/.ssh
  echo -e "Please add the allowed keys to the authorized_keys file."
fi


# Remove debian cloud-init user from /etc/sudoers.d/debian-cloud-init
# and /etc/sudoers.d/90-cloud-init-users
